...
class Interface:
    ...
    def draw_bars(self):
        ...
        pygame.draw.rect(
            ...
            (20, 600, HEALTH_WIDTH * min(100, self.game.level.player.hp_value), HEALTH_HEIGHT)
        )
        pygame.draw.rect(
            self.display, (0, 0, 255),
            (20, 630, WATER_WIDTH * min(100, self.game.level.player.water_value), WATER_HEIGHT)
        )
        pygame.draw.rect(
